...
<script type="text/javascript" >
    ...
    function  /*void*/ setPatientInfo(nationalID, ST_ID, subjectNumber, lastName, firstName, aka, mother, street, city, dob, gender,
        ...
        if (supportNationalID) {
            $("nationalID").value = nationalID == undefined ? "" : nationalID;
        }
        if (supportSTNumber) {
        ...
        if (supportAKA) {
            $("akaID").value = aka == undefined ? "" : aka;
        }
        if (supportMothersName) {
            $("motherID").value = mother == undefined ? "" : mother;
        }
        if (supportMothersInitial) {
            $("motherInitialID").value = (motherInitial == undefined ? "" : motherInitial);
        }
        $("streetID").value = street == undefined ? "" : street;
        if (supportCity) {
            $("cityID").value = city == undefined ? "" : city;
        }
        if (supportCommune) {
            $("communeID").value = commune == undefined ? "" : commune;
        }
        if (supportInsurance) {
            $("insuranceID").value = insurance == undefined ? "" : insurance;
        }
        if (supportOccupation) {
            $("occupationID").value = occupation == undefined ? "" : occupation;
        }
        ...
        if (supportEducation) {
            $("educationID").selectedIndex = educationId == undefined ? 0 : educationId;
        }
        if (supportMaritialStatus) {
            $("maritialStatusID").selectedIndex = maritialStatusId == undefined ? 0 : maritialStatusId;
        }
    ...
    <div id="PatientDetail"   >
        ...
        <table style="width:80%" border="0">
            ...
            <nested:text name='<%=formName%>'
                         ...
                         onchange="validateSubjectNumber(this, 'STnumber');
                                 updatePatientEditStatus();"
                         styleId="ST_ID"
                         styleClass="text"
                         size="60" />
            ...
            <nested:text name='<%=formName%>'
                         ...
                         onchange="validateSubjectNumber(this, 'nationalId');
                                 updatePatientEditStatus();"
                         styleId="nationalID"
                         styleClass="text"
                         size="60"/>
